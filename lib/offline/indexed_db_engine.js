...
goog.provide('shaka.offline.IndexedDBEngine');
 ...
 */
shaka.offline.IndexedDBEngine = function() {
  goog.asserts.assert(
      shaka.offline.IndexedDBEngine.isSupported(),
      'IndexedDBEngine should not be called when IndexedDBEngine is not supported');

  /** @private {IDBDatabase} */
  this.db_ = null;

  /** @private {!Array.<shaka.offline.IndexedDBEngine.Operation>} */
  this.operations_ = [];
 ...
 */
shaka.offline.IndexedDBEngine.Operation;


/** @private {string} */
shaka.offline.IndexedDBEngine.DB_NAME_ = 'shaka_offline_db';


/** @private @const {number} */
shaka.offline.IndexedDBEngine.DB_VERSION_ = 1;
 ...
 * @return {boolean}
 */
shaka.offline.IndexedDBEngine.isSupported = function() {
 ...
 * @return {!Promise}
 */
shaka.offline.IndexedDBEngine.deleteDatabase = function() {
  if (!window.indexedDB)
    return Promise.resolve();
  var request =
      window.indexedDB.deleteDatabase(shaka.offline.IndexedDBEngine.DB_NAME_);
  ...
  request.onerror = shaka.offline.IndexedDBEngine.onError_.bind(null, request, p);
  return p;
};


/** @override */
shaka.offline.IndexedDBEngine.prototype.initialized = function() {
  return this.db_ != null;
};


/** @override */
shaka.offline.IndexedDBEngine.prototype.init = function(storeMap, opt_retryCount) {
...
/** @override */
shaka.offline.IndexedDBEngine.prototype.destroy = function() {
...
/** @override */
shaka.offline.IndexedDBEngine.prototype.get = function(storeName, key) {
  /** @type {!IDBRequest} */
  var request;
...
/** @override */
shaka.offline.IndexedDBEngine.prototype.forEach = function(storeName, callback) {
  return this.createTransaction_(storeName, 'readonly', function(store) {
...
/** @override */
shaka.offline.IndexedDBEngine.prototype.insert = function(storeName, value) {
...
/** @override */
shaka.offline.IndexedDBEngine.prototype.remove = function(storeName, key) {
  return this.createTransaction_(storeName, 'readwrite', function(store) {
    store.delete(key);
  });
};
...
/** @override */
shaka.offline.IndexedDBEngine.prototype.removeKeys = function(storeName,
                                                       keys,
                                                       opt_onKeyRemoved) {
  return this.createTransaction_(storeName, 'readwrite', function(store) {
...
/** @override */
shaka.offline.IndexedDBEngine.prototype.reserveId = function(storeName) {
 ...
 * @private
 */
shaka.offline.IndexedDBEngine.prototype.getNextId_ = function(storeName) {
  var id = 0;
  return this.createTransaction_(storeName, 'readonly', function(store) {
 ...
 * @private
 */
shaka.offline.IndexedDBEngine.prototype.createTransaction_ = function(storeName,
                                                               type,
                                                               action) {

  goog.asserts.assert(this.db_, 'IndexedDBEngine must not be destroyed');
  ...
  op.transaction.onabort = (function(event) {
    this.closeOperation_(op);
    shaka.offline.IndexedDBEngine.onError_(op.transaction, op.promise, event);
  }.bind(this));
 ...
 *
 * @param {!shaka.offline.IndexedDBEngine.Operation} op
 * @private
 */
shaka.offline.IndexedDBEngine.prototype.closeOperation_ = function(op) {
 ...
 * @private
 */
shaka.offline.IndexedDBEngine.prototype.createConnection_ = function(
    storeMap, opt_retryCount) {
  var IndexedDBEngine = shaka.offline.IndexedDBEngine;

  var indexedDB = window.indexedDB;
  var request = indexedDB.open(IndexedDBEngine.DB_NAME_, IndexedDBEngine.DB_VERSION_);
  ...
  request.onerror = IndexedDBEngine.onError_.bind(null, request, createPromise);
 ...
 * @private
 */
shaka.offline.IndexedDBEngine.onError_ = function(errorSource, promise, event) {
